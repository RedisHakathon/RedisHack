    ...
    if st.button("Discover Scholarly Papers"):
        if Search_query is not None:
            ...
            for p in results.docs:
                st.markdown(
                    f""" <div class="card border-success mb-3" style="max-width:30rem;background-color:#ccc; border-radius:10px;">   
                    ...
                    <div class="card-body text-success">
                      <p class="card-title" style="color:#000000; margin:20px;margin-top:-5px;"><i>{p.author}:({p.year})</i></p>
                    </div>
                    </div> """,
                    unsafe_allow_html=True,
                    )       
